...
Este curso de **25 horas presenciales** (5 días intensivos) está diseñado para profesionales que desean dominar las mejores prácticas de seguridad en el desarrollo de software, alineadas con estándares internacionales.
...
Dirígete al [Día 1](./dia-1/intro) para comenzar tu viaje en el desarrollo seguro.
