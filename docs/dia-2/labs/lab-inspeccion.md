...
2. El inspector debe revisar el componente completo una vez por cada tipo de defecto, enfocándose en encontrar los defectos correspondientes al tipo de defecto que está revisando.
